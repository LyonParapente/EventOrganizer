...
If you're new with Python, pip and virtualenv, checkout [Installing packages using pip and virtual environments](https://packaging.python.org/guides/installing-using-pip-and-virtual-environments/)
Basically meaning:
```
# install virtualenv
...
curl -i -H "Content-Type: application/json" -X POST -d '{"title":"ca vole ou?", "start_date": "2020-02-26"}' https://letsgoglidingw.azurewebsites.net/letsgogliding/api/v1.0/events
...
It will create a python 3.6 virtual environment automatically because of requirements.txt
...
# Need to install requirements for the Python install we just made
