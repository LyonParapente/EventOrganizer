...
class UserBase(Schema):
  ...
  share_email = fields.Boolean(load_only=True, metadata={'description': 'Does the user allow his/her email to be public?', 'example': False})
  phone = fields.String(metadata={'example': '01.02.03.04.05'})
  share_phone = fields.Boolean(load_only=True, metadata={'description': 'Does the user allow his/her phone to be public?', 'example': False})
  has_whatsapp = fields.Boolean(metadata={'example': False})
  notif_new_event = fields.Boolean(load_only=True, metadata={'description': en['notif_new_event'], 'example': True})
  notif_event_change = fields.Boolean(load_only=True, metadata={'description': en['notif_event_change'], 'example': True})
  notif_tomorrow_events = fields.Boolean(load_only=True, metadata={'description': en['notif_tomorrow_events'], 'example': True})
...
class UserResponse(UserBase):
  ...
  creation_datetime = fields.DateTime(format='iso', dump_only=True, required=True, metadata={'example': '2020-04-13T16:30:04.461593'})
  last_login_datetime = fields.DateTime(format='iso', dump_only=True, required=True, metadata={'example': '2020-04-13T16:30:04.461593'})
