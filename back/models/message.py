...
class MessageResponse(Schema):
  ...
  creation_datetime = fields.DateTime(format='iso8601', dump_only=True, required=True, example='2020-04-13T16:30:04.403284')
...
class MessagesComment(Schema):
  date = fields.DateTime(format='iso8601', example='2020-04-13T16:30:04.403284', required=True)
